...
//   constructor(fi: LFile, text: string) {
//     this.fi = fi
//     var tabCount = 4
//     var first1 = true
//     this.fi.fields.items.forEach((v1, k1) => {
//       if (v1.isNewVar) {
//         if (!first1) {
//           first1 = false
//           this.formatComent += "\n"
//         }
//         this.formatComent += "export class " + k1 + " {\n"

//         var first2 = true
//         var writeFields = (fields: LCItem, inner: boolean) => {
//           fields.items.forEach((v2, k2) => {
//             if (!first2) {
//               first2 = false
//               this.formatComent += "\n"
//             }
...
//               this.formatComent += " "
//             }
//             if (LParse.ins.Compare("=", v2.token.next, LTT.Punctuator)) {
//               if (v2.items.size > 0) {
//                 if (inner) {
//                   this.formatComent += v2.label + " : " + v2.label + ",\n"
//                 } else {
//                   this.formatComent += "public static " + v2.label + " :any = {\n"
//                 }
//                 tabCount += 4
//                 writeFields(v2, true)
//                 tabCount -= 4
...
//               } else {
//                 if (inner) {
//                   this.formatComent += v2.label + " : " + v2.token.next.next.value + ",\n"
//                 }
//                 else {
//                   this.formatComent += "public static " + v2.label + " = " + v2.token.next.next.value + "\n"
//                 }
//               }
//             } else {
//               if (inner) {
//                 this.formatComent += v2.label + ",\n"
//               } else {
//                 this.formatComent += "public static " + v2.label
//               }
//             }
//           })
//         }
//         writeFields(v1, false)
